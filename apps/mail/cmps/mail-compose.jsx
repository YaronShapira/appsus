...
export function MailCompose({ sendMail, draftMail }) {
    ...
    return (
        <section className={`mail-compose ${isMailEdited ? 'open' : ''} ${isExpandedMsgWindow ? 'expand' : ''}`}>
            <button
                title='Compose Mail'
            ...
            <section
                ...
                <form onSubmit={onSendMail} className={`flex flex-column ${isMailMinimized ? 'minimized' : ''} `}>
                    <section className='compose-mail-form-header flex align-center justify-between'>
                        <h5>{}New Mail</h5>
                        <div className='header-tools'>
                            <button onClick={onMinimizeMsgWindow} title='Minimize' type='button' className='btn-rnd-s'>
                                <i className='fa-solid fa-window-minimize'></i>
                            </button>
                            <button onClick={onExpandMsgWindow} title='Expand' type='button' className='btn-rnd-s'>
                                {isExpandedMsgWindow ? (
                            ...
                            <button onClick={onBtnToggleCompose} title='Close' type='button' className='btn-rnd-s'>
                    ...
                    <div className='compose-mail-form-footer flex align-center justify-between'>
                        ...
                        <section className='footer-tools'>
                            ...
                            <button title='Sign' onClick={onBtnToggleCompose} type='button' className='btn-rnd-l-s'>
